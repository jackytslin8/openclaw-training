...
> **快速導覽：**
- [案例 1 — 🌤️ 每日天氣預報推送](#案例-1-每日天氣預報推送) 
- [案例 2 — 🔌 水電帳單自動記錄](#案例-2-水電帳單自動記錄) 
- [案例 3 — 🎓 Excel 報表線上化](#案例-3-excel-報表線上化) 
- [案例 4 — 🏠 房屋修繕費用追蹤](#案例-4-房屋修繕費用追蹤) 
- [案例 5 — 🎮 做遊戲互動](#案例-5-做遊戲互動) 
- [案例 6 — 🚲 即時Ubike數量查詢](#案例-6-ubike數量查詢) 
- [案例 7 — 🏘️ 實價登錄查詢](#案例-7-實價登錄查詢) 
- [案例 8 — ✍️ 寫腳本自動簽到](#案例-8-寫腳本自動簽到) 
- [案例 9 — 👩‍⚕ 中華民國30年來出生率vs死亡率變化](#案例-9-中華民國30年來出生率vs死亡率變化) 
- [案例 10 — 🚂 臺鐵每日運輸量](#案例-10-臺鐵每日運輸量)
