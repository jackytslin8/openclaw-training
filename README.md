...
- **極力推薦新增的Skill：Grill me**：(https://github.com/zhudan930612/grill-me/blob/main/README.md) 進行專案前拷問你，對焦內容
- **極力推薦新增的部署：Omni**：(https://github.com/diegosouzapw/OmniRoute) 免費token，享受token free
- **效果**：[社會科考題實作流程](https://jackytslin8.github.io/openclaw-training//case10/google_forms_social_quiz.html)

- ### 案例 12：課程管理平台
- **情境**：老師上課行事曆進度與備註
- **做法**：prompt：我想要有一個互動式的HTML或是網站，可以在每天的行事曆輸入各班級(例如605，是指六年五班)的教課進度，例如506 作業社練P2~3，P23~24，方便我管理課程進度
...
| ✏️ 點擊輸入 | 點格子彈出輸入框，輸入班級+進度 |

| ⚡️ 快速選取 | 常用班級（506, 605, 606, 609, 610）一鍵填入 |

| 📊 進度統計 | 自動統計各班級教了多少節課 |

| 💾 備份匯出 | 匯出 JSON 備份，换電腦也能用 |

| 📤 匯入備份 | 支援匯入回復資料 |

📝 使用方式

1. 開啟網頁：用瀏覽器打開 course-schedule.html
